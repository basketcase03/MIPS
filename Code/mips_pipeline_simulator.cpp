...
#include <cstring>     //for ease with strings
#include <cstdlib>     //for macros and functions
#include <cmath>       //for math functions
#include<stdint.h>      //declare sets of integer types having specified widths, and define corresponding sets of macros
#include <iostream>     //using the classes
#include<stdio.h>       //for easier string formatting


// -------------OPCODES---------//               

#define OP_ADD 32   //100000
#define OP_SUB 34   //100010
#define OP_SLL 0
...
void addInstruction(Instruction i)
{
    ...
    printf("Done Adding Instruction\n");
}
...
void parseInput(void)
{
    ...
    std::cout<<"Enter data segments: (Once entered, use Ctrl+Z to mark end of input)\n";

    // Parse Data Segments
    i = 0;
    while(fgets(lineBuffer,DATA_MEM, stdin))
    {
...
void IntroductoryMessage(){
	std::cout<<"<----------MIPS PIPELINE---------->\n";
	std::cout<<"Welcome to the MIPS Pipeline simulation.\n Enter the instruction that are to be implemented in the integer format.\n";
	std::cout<<"Example- 17387552 for add $t2,$t0,$t1 \n";
	std::cout<<"The maximum number of instructions supported is 100. \n";
	//std::cout<<"Once all the instructions are entered press ctrl+Z to mark the end of input and get the result of the program\n";
	std::cout<<"Enter the instruction:  (Use the HALT to mark the end of input)\n";
...
int main()
{
    ...
    IntroductoryMessage();
    parseInput();
    std::cout<<"Input has been provided. Output -> \n";
